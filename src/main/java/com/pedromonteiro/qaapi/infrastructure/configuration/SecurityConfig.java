...
public class SecurityConfig {
    ...
    private static final String ROLE_ADMIN = "QA_ADMIN";
    private static final String ROLE_USER = "QA_USER";
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                ...
                .oauth2ResourceServer(oauth -> {
                    oauth.jwt(conf -> conf.jwtAuthenticationConverter(new KeycloakJwtConverter()));
    ...
    static class KeycloakAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
        ...
        public Collection<GrantedAuthority> convert(final Jwt jwt) {
            ...
            final Function<Set<Map.Entry<String, Object>>, Collection<String>> mapResources = resources -> resources.stream()
                    .flatMap(mapResource)
                    .toList();
